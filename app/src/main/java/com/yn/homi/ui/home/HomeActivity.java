...
import com.yn.homi.ui.shop.BannerAdapter;
import com.yn.homi.ui.home.BestSellerAdapter;
import com.yn.homi.ui.home.FlashSaleAdapter;
import com.yn.homi.ui.shop.IdeaAdapter;
import com.yn.homi.ui.shop.IdeaCategoryAdapter;
...
import com.yn.homi.ui.profile.SettingActivity;
...
public class HomeActivity extends com.yn.homi.core.BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (btnAccount != null) {
            btnAccount.setOnClickListener(v -> {
                Intent intent = new Intent(HomeActivity.this, com.yn.homi.ui.profile.profile.YourProfileActivity.class);
                startActivity(intent);
            });
        }
        ...
        if (btnLists != null) {
            btnLists.setOnClickListener(v -> {
                Intent intent = new Intent(HomeActivity.this, com.yn.homi.ui.profile.wishlist.WishlistActivity.class);
                startActivity(intent);
            });
        }
    ...
    private void fetchQuickTabs() {
        firestoreRepository.getQuickTabs(new FirestoreRepository.OnQuickTabsLoadedListener() {
            @Override
            public void onLoaded(List<com.yn.homi.data.model.QuickTab> quickTabs) {
    ...
    private void updateCartBadge() {
        ...
        int count = com.yn.homi.ui.cart.CartManager.getInstance(this).getTotalItemCount();
        if (count > 0) {
