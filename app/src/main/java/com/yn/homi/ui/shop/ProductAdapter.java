...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ProductViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        if (hasSaleEffect) {
            ...
            holder.tvSalePriceOnImage.setText(String.format(Locale.US, "$%.2f", product.getPrice()));
        } else {
        ...
        if (product.getOriginalPrice() > product.getPrice() || product.getDiscountPercent() > 0) {
            ...
            String salePrice = String.format(Locale.US, "$%.2f", product.getPrice());
            String originalPriceStr = String.format(Locale.US, "$%.2f", displayOriginalPrice);
        ...
        if (finalImageUrl != null && !finalImageUrl.isEmpty()) {
            com.bumptech.glide.load.model.GlideUrl glideUrl = new com.bumptech.glide.load.model.GlideUrl(finalImageUrl,
            ...
            holder.ivProduct.setImageResource(android.R.color.white);
        }
